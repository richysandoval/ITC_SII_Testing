...
# 266 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
void   lr_new_prefix (int type,
                                 char * filename,
                                 int line);
# 508 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 532 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int   lr_eval_string_ext (const char *in_str,
                                     ...
                                     const char *file,
								     long const line);
# 566 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int lr_param_increment (char * dst_name,
                              char * src_name);
# 589 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int	  lr_save_var (char *              param_val,
							  ...
							  unsigned long const options,
							  char *			  param_name);
# 613 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 692 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int lr_table_get_column_name_by_index (char * param_name, int col, 
											char * * const col_name,
											int * col_name_len);
# 753 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 768 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int   lr_param_substit (char * file,
                                   ...
                                   char * * const out_str,
                                   int * const out_len);
# 792 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
void   lr_param_substit_free (char * * pstr);


 
# 804 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
char *   lrfnc_eval_string (char * str,
                                      char * file_name,
                                      long const line_num);
# 812 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int   lrfnc_save_string ( const char * param_val,
                                     ...
                                     long const line_num);
# 818 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 916 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int   lr_save_value (char * param_val,
                                ...
                                char * file_name,
                                long const line_num);
# 923 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int   lr_set_debug_message (unsigned int msg_class,
                                       unsigned int swtch);
# 945 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 1021 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 1050 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"


# 1062 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 100 "C:\\Program Files\\HP\\LoadRunner\\include/SharedParameter.h"
...
# 716 "C:\\Program Files\\HP\\LoadRunner\\include/as_web.h"


# 729 "C:\\Program Files\\HP\\LoadRunner\\include/as_web.h"
...
# 767 "C:\\Program Files\\HP\\LoadRunner\\include/as_web.h"
...
# 835 "C:\\Program Files\\HP\\LoadRunner\\include/as_web.h"
...
lr_end_transaction("SII_Student_ChangePass_00_openURL",2);
...
timer = lr_start_timer( ); lr_start_transaction("SII_Student_ChangePass_01_login");
	...
	if(strcmp(lr_eval_string("{UserMessageInvalid}"),"Usuario o contraseña incorrecto") == 0){
		...
		lr_end_transaction("SII_Student_ChangePass_01_login",1);
		lr_exit( 2,1 );
	}

lr_end_transaction("SII_Student_ChangePass_01_login",2);
...
lr_end_transaction("SII_Student_ChangePass_02_ClickChangePassOption",2);
...
timer = lr_start_timer( ); lr_start_transaction("SII_Student_ChangePass_03_UpdatePassword");
	...
	if(strcmp(lr_eval_string("{PassUpdated}"),"Actualización de contraseña") != 0){		
		if(strcmp(lr_eval_string("{ErrorMessage}"),"") != 0){
			...
			lr_end_transaction("SII_Student_ChangePass_03_UpdatePassword",1);
			goto logout;
		}
		else{
...
lr_end_transaction("SII_Student_ChangePass_03_UpdatePassword",2);
...
lr_end_transaction("SII_Student_ChangePass_04_logout",2);
